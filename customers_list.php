    ...
    <section class="shopping-cart">
        ...
        <table>
            ...
            <tbody>
                ...
                $select_cart = mysqli_query($con, "SELECT * FROM `customers` where cidCustomer != 'admin' ");
                ...
                <tr>
                    ...
                    <td><?php echo $fetch_cart['last_name'].' '.$fetch_cart['first_name']; ?></td>
                    <td><?php echo $fetch_cart['phone_num']; ?></td>
