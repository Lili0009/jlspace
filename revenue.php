    ...
    <section class="shopping-cart">
        ...
        <table>
            ...
            <tbody>
                ...
                $select_cart = mysqli_query($con, "SELECT * FROM orders where order_status='Confirmed' AND payment_status = 'Paid'");
                $grand_total = 0;
        ...
        <p style="float: right;">Total Revenue : <?php echo $grand_total; ?></p>
