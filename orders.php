    ...
    <section class="shopping-cart">
        ...
        <table>
            ...
            <tbody>
                ...
                $select_cart = mysqli_query($con, "SELECT * FROM `orders` WHERE order_status = 'Confirmed' AND payment_status = 'Unpaid'");
                $grand_total = 0.00;
                ...
                <tr>
                    ...
                    <td>
                        <button id="paymentButton" class="payment-button " onclick="paymentAction(this, <?php echo $fetch_cart['order_id']; ?>)">
                            <?php echo $fetch_cart['payment_status']; ?>
                        </button>
                    </td>
                </tr>
                <?php
